...
const FilterControls: FC<FilterControlsProps> = ({
  ...
  const { filterControlFactory, filtersWithValues: allFiltersWithValues } =
    useFilterControlFactory(
      dataMaskSelected,
      onFilterSelectionChange,
      clearAllTriggers,
      onClearAllComplete,
    );
  // iris-new: when inline chart filters are enabled, hide the single-chart
  // `filter_preset_or_custom` filters from the top filter bar — they render
  // inline in each chart header instead (see SliceHeader/index.tsx).
  ...
  const filtersWithValues = useMemo(
    () =>
      embedChartFilters
        ...
        : allFiltersWithValues,
    [embedChartFilters, allFiltersWithValues],
  );
    ...
    () => (
      ...
      >
        <DropdownContainer
          ...
          // iris-new: suppress the hover tooltip that listed applied filter names.
