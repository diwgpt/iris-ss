...
class DashboardJSONMetadataSchema(Schema):
    ...
    # Custom flag (iris-new): opt-in for rendering single-chart
    # filter_preset_or_custom filters inline in each chart's header instead of
    # in the dashboard-wide filter bar. See SliceHeader/index.tsx and
    # FilterControls/Horizontal.tsx for the consuming logic.
    embed_chart_filters = fields.Boolean(load_default=False)
